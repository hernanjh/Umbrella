...
public record ZoneDto(int Id, string Code, string Name, string? Description, bool IsActive);
public record CreateZoneDto(string Code, string Name, string? Description);
public record UpdateZoneDto(string Name, string? Description, bool IsActive);
