...
public class ParamsController : BaseController
{
    ...
    [HttpPost("client-types")] public async Task<IActionResult> CreateClientType([FromBody] CreateClientTypeDto dto)
    ...
    [HttpPut("client-types/{id}")] public async Task<IActionResult> UpdateClientType(int id, [FromBody] UpdateClientTypeDto dto)
    ...
    [HttpDelete("client-types/{id}")] public async Task<IActionResult> DeleteClientType(int id)
    ...
    [HttpPost("vat-conditions")] public async Task<IActionResult> CreateVatCondition([FromBody] CreateVatConditionDto dto)
    ...
    [HttpPut("vat-conditions/{id}")] public async Task<IActionResult> UpdateVatCondition(int id, [FromBody] UpdateVatConditionDto dto)
    ...
    [HttpPost("payment-conditions")] public async Task<IActionResult> CreatePaymentCondition([FromBody] CreatePaymentConditionDto dto)
    ...
    [HttpPut("payment-conditions/{id}")] public async Task<IActionResult> UpdatePaymentCondition(int id, [FromBody] UpdatePaymentConditionDto dto)
    ...
    [HttpPost("categories")] public async Task<IActionResult> CreateCategory([FromBody] CreateCategoryDto dto)
    ...
    [HttpPut("categories/{id}")] public async Task<IActionResult> UpdateCategory(int id, [FromBody] UpdateCategoryDto dto)
    ...
    [HttpPut("system-config")] public async Task<IActionResult> UpdateSystemConfig([FromBody] UpdateSystemConfigDto dto)
